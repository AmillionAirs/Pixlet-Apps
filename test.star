            ...
            children = [
                ...
                render.Row(
                    children = [
                        render.Stack(
                            children = [
                                render.Image(src=Haas),
                                render.Text("1"),
                            ],
                        ),
                        render.Marquee(
                            width=50,
                            child=render.Text("Mercedes 544pts"),
                            offset_start=5,
                            offset_end=5,
                        ),
                    ],
                ...
                render.Row(
                    children = [
                        render.Stack(
                            children = [
                                render.Image(src=McLauren),
                                render.Text("2"),
                            ],
                        ),
                        render.Marquee(
                            width=50,
                            child=render.Text("Alpha Tauri 34pts"),
                            offset_start=5,
                            offset_end=5,
                        ),
                    ],
                 ...
                 render.Row(
                    children = [
                        render.Stack(
                            children = [
                                render.Image(src=Alfa_Romeo),
                                render.Text("3", font="5x8"),
                            ],
                        ),
                        render.Marquee(
                            width=50,
                            child=render.Text("Alpine 1pts"),
                            offset_start=5,
                            offset_end=5,
                        ),
                    ],
