...
def main(config):
    ...
    if Constructor1 == "Alfa Romeo":
        Image1 = Alfa_Romeo

    elif Constructor1 == "Red Bull":
        Image1 = RedBull

    elif Constructor1 == "Mercedes":
        Image1 = Mercedes         

    elif Constructor1 == "AlphaTauri":
        Image1 = Alpha_Tauri 

    elif Constructor1 == "Alpine F1 Team":
        Image1 = Alpine 

    elif Constructor1 == "Ashton Martin":
        Image1 = Aston_Martin                 

    elif Constructor1 == "Ferrari":
        Image1 = Ferrari 

    elif Constructor1 == "Haas F1 Team":
        Image1 = Haas 
    ...
    if Constructor2 == "Alfa Romeo":
        Image2 = Alfa_Romeo

    elif Constructor2 == "Red Bull":
        Image2 = RedBull

    elif Constructor2 == "Mercedes":
        Image2 = Mercedes         

    elif Constructor2 == "AlphaTauri":
        Image2 = Alpha_Tauri 

    elif Constructor2 == "Alpine F1 Team":
        Image2 = Alpine 

    elif Constructor2 == "Ashton Martin":
        Image2 = Aston_Martin                 

    elif Constructor2 == "Ferrari":
        Image2 = Ferrari 

    elif Constructor2 == "Haas F1 Team":
        Image2 = Haas 
    ...
    if Constructor3 == "Alfa Romeo":
        Image3 = Alfa_Romeo

    elif Constructor3 == "Red Bull":
        Image3 = RedBull

    elif Constructor3 == "Mercedes":
        Image3 = Mercedes         

    elif Constructor3 == "AlphaTauri":
        Image3 = Alpha_Tauri 

    elif Constructor3 == "Alpine F1 Team":
        Image3 = Alpine 

    elif Constructor3 == "Ashton Martin":
        Image3 = Aston_Martin                 

    elif Constructor3 == "Ferrari":
        Image3 = Ferrari 

    elif Constructor3 == "Haas F1 Team":
        Image3 = Haas 

    elif Constructor3 == "McLaren":
        Image3 = McLaren 
