...
def main(config):
    ...
    if f1_cached != None:
        ...
        Constructor1 = F1_URL.json()["MRData"]["StandingsTable"]["StandingsLists"][0]["ConstructorStandings"][0]["Constructor"]["constructorId"]
        Constructor2 = F1_URL.json()["MRData"]["StandingsTable"]["StandingsLists"][0]["ConstructorStandings"][1]["Constructor"]["constructorId"]
        Constructor3 = F1_URL.json()["MRData"]["StandingsTable"]["StandingsLists"][0]["ConstructorStandings"][2]["Constructor"]["constructorId"]

        Points1 = F1_URL.json()["MRData"]["StandingsTable"]["StandingsLists"][0]["ConstructorStandings"][0]["points"]
        Points2 = F1_URL.json()["MRData"]["StandingsTable"]["StandingsLists"][0]["ConstructorStandings"][1]["points"]
        Points3 = F1_URL.json()["MRData"]["StandingsTable"]["StandingsLists"][0]["ConstructorStandings"][2]["points"]
